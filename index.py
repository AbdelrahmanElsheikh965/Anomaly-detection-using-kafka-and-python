...
def create_kafka_consumer(topic_name, bootstrap_servers):
    ...
    return KafkaConsumer(topic_name, 
                         ...
                         auto_offset_reset='earliest',  # Ensure the consumer reads from the beginning
...
if __name__ == "__main__":
    ...
    produce_synthetic_data(raw_data_producer, 'raw-data', num_data_points=100)  # Reduced data points for faster results
